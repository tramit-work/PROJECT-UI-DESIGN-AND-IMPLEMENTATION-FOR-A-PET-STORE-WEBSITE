const slides = [
  {
    ...
    altText: 'Chó giống Australian Shepherd lông nâu trắng đang vui vẻ'
  },
  {
  ...
  },
  {
    ...
    altText: 'Con vẹt sặc sỡ đang đậu trên cành'
  }
];
...
document.querySelectorAll('.button-readmore').forEach(button => {
  button.addEventListener('click', () => {
    alert("Bạn đã nhấn ĐẶT LỊCH NGAY cho: " + 
      button.closest('.feature-card').querySelector('.feature-title').textContent);
  });
});
